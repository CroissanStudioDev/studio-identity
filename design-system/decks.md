...
| Сетка | absolute positioning. Это **Figma Slides**, не Auto Layout. Не делай адаптив — слайд фиксированного размера |
...
Все размеры — точно как в Figma-мастере. Tracking везде ≈ -2% ширины символа.
...
Когда какой использовать — см. [`../assets/deck-template/README.md`](../assets/deck-template/README.md#when-to-use-this-vs-figma).
